export const GENERATION_APP_URI = 'ui://hansora/generation-v1.html';
...
<body>
  <main class="card" aria-live="polite">
    ...
    <section id="ready" class="hidden">
      ...
      <div class="result-body"><div class="result-row"><div><h1 class="title">Your creation is ready</h1><p class="sub" id="readyDetails"></p></div></div><p class="prompt" id="readyPrompt"></p><div class="actions"><a class="button primary" id="download" target="_blank" rel="noopener noreferrer" download>Download result</a><a class="button" id="open" target="_blank" rel="noopener noreferrer">Open full size</a></div></div>
    </section>
  ...
  (() => {
    ...
    function render(value) {
      ...
      if (status === 'ready') {
        ...
        el('download').href = resultUrl; el('open').href = resultUrl;
