...
// Create Seedream 4.5 job and immediately return "submitted".
...
if (!API_KEY) console.warn("[run-seedream-4-5] Missing KIE_API_KEY env!");
...
const VERSION_TAG  = "seedream_4_5_fn_v1";
