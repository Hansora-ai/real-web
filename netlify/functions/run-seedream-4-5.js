...
// Seedream 4.5 launcher with server-side credit debit (Service Role) + run_id idempotency.
...
async function seedUserGeneration(uid, run_id, prompt, metaExtra){
  ...
  try{
    ...
    const meta = Object.assign(
      { source:"seedream-4.5", run_id, model:"seedream-4.5", status:"pending", charged:"false" },
      (metaExtra||{})
    );
